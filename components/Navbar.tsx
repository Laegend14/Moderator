...
import { FileReportModal } from "./FileReportModal"; // Renamed from CreateBetModal
import { useCases } from "../lib/hooks/useModeration"; // Renamed hook
          ...
          >
            ...
            >
              ...
              <div className="flex items-center gap-3">
                ...
                <span className="text-lg md:text-xl font-bold ml-2 tracking-tight">
                  GenLayer <span className="text-accent">Arbitrate</span>
                </span>
              </div>
              ...
              <div className="hidden lg:flex items-center gap-6 text-sm">
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-foreground font-bold text-accent">{totalCases}</span>
                </div>
                <div className="flex items-center gap-2">
                  <span className="text-muted-foreground">Arbitrated:</span>
                  <span className="text-foreground font-bold text-accent">{closedCases}</span>
                </div>
              </div>
